...
- If a correction is needed:
    ...
    3. **Technical feedback**: Provide actionable feedback in `<angels_steering_message>...</angels_steering_message>`.
...
<angels_steering_message>Do not use placeholders like "// ... rest of code here ...". Provide the full implementation as requested.</angels_steering_message>
...
<angels_decision>Steer</angels_decision>
<angels_steering_message>The path points to a directory. `os.remove()` only works for files. Use `shutil.rmtree()` or `os.rmdir()` for directory removal.</angels_steering_message>
