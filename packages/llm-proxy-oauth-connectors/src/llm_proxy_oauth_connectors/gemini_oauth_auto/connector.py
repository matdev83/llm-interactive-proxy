...
from llm_proxy_oauth_connectors.gemini_oauth_auto.account_selector import (
    AccountSelectorService,
)
from llm_proxy_oauth_connectors.gemini_oauth_auto.models import StoredAccount
from llm_proxy_oauth_connectors.gemini_oauth_auto.token_refresh import (
    TokenRefreshService,
)
from llm_proxy_oauth_connectors.gemini_oauth_auto.token_storage import (
    TokenStorageService,
)
from llm_proxy_oauth_connectors.gemini_oauth_base import GeminiOAuthBaseConnector
...
class GeminiOAuthAutoConnector(GeminiOAuthBaseConnector):
    ...
    async def initialize(self, **kwargs: Any) -> None:
        ...
        from llm_proxy_oauth_connectors.gemini_oauth_auto.models import (
            GeminiOAuthAutoConfig,
        )
