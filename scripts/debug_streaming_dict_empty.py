...
condition = streaming_content.is_empty and not streaming_content.is_done and not streaming_content.content
...
print(f"Skip condition: {streaming_content_dash.is_empty and not streaming_content_dash.is_done and not streaming_content_dash.content}")
