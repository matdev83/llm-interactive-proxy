...
def print_translation(droid_tool: str, droid_args: dict, codex_tool: str, codex_args: dict) -> None:
...
def demo_tool_translations() -> None:
    ...
    demo_cases = [
        ...
        # Glob tool
        ("Glob", {"patterns": ["**/*.py", "**/*.md"], "excludePatterns": ["**/node_modules/**"]}),
        
        # Proxy-side tools (no Codex equivalent)
        ("TodoWrite", {"todos": [{"id": "1", "content": "Implement feature", "status": "pending"}]}),
        ("WebSearch", {"query": "python asyncio best practices"}),
        ("FetchUrl", {"url": "https://docs.python.org/3/library/asyncio.html"}),
        ("ExitSpecMode", {"plan": "1. Add tests\n2. Implement feature\n3. Update docs", "title": "Feature X"}),
    ]
    
    for droid_tool, droid_args in demo_cases:
        try:
            codex_tool, codex_args = translator.translate_tool_call(droid_tool, droid_args)
...
def demo_client_detection() -> None:
    ...
    demo_cases = [
        ...
        # Droid system prompt
        {
            ...
            "headers": None,
            "messages": [{"role": "system", "content": "You are Droid, an AI software engineer..."}],
            "tools": None,
        },
        # Droid tool names
        {
        ...
        # Non-Droid (Cline)
        {
            ...
            "messages": [{"role": "system", "content": "You are Cline, a skilled software engineer..."}],
            "tools": None,
        },
    ]
