...
replacements = [
    ...
    (r"self\._stream_as_sse_bytes\(", "self._stream_formatting_service.stream_as_sse_bytes("),
    
    (r"self\._is_valid_completion_token\(", "self._stream_formatting_service.is_valid_completion_token("),
    
    (r"self\._wrap_stream_for_usage\(", "self._usage_tracking_wrapper.wrap_stream_for_usage("),
    ...
    (r"self\._apply_planning_phase_if_needed\(", "self._planning_phase_manager.apply_if_needed("),
    
    (r"self\._update_planning_phase_counters\(", "self._planning_phase_manager.update_counters("),
    
    (r"self\._count_file_writes_in_response\(", "self._planning_phase_manager.count_file_writes("),
    
    (r"self\._get_or_create_backend\(", "self._backend_lifecycle_manager.get_or_create("),
    ...
    (r"self\._restore_planning_phase_route\(", "# self._restore_planning_phase_route("), # This was no-op in wrapper?
    ...
    (r"self\._enforce_per_session_backend_limit\(", "# self._enforce_per_session_backend_limit("), # No-op wrapper
]
