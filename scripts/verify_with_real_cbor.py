...
async def test_with_real_cbor_data():
    ...
    cbor_path = project_root / "var" / "wire_captures_cbor" / "22523e34faf943b8b2c4116204cbc9c0.cbor"
    ...
    request = ChatRequest(
        model="test-model",
        messages=[ChatMessage(role="user", content=actual_prompt)]
    )
    ...
    old_buggy_result = "C:\\Users\\Mateusz\\source\\repos\\patch-file-mcp-fork\\.venv\\Scripts"
