...
class SecureCommandBase(ABC):
    ...
    def get_state_setting(self, setting_name: str) -> Any:
        """Get a state setting through secure access.
        ...
        Raises:
            StateAccessViolationError: If state reader is not injected
        """
    ...
    def update_state_setting(self, setting_name: str, value: Any) -> None:
        """Update a state setting through secure access.
        ...
        Raises:
            StateAccessViolationError: If state modifier is not injected
        """
