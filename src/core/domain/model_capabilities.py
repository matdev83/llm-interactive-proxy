...
KNOWN_MODEL_CAPABILITIES = {
    ...
    "zai-coding-plan": ModelCapabilities(
        ...
        metadata=ModelMetadata(
            ...
            display_name="ZAI Coding Plan (GLM 4.6)",
            description="ZAI's coding plan powered by Zhipu GLM 4.6",
            provider="ZAI",
            version="4.6",
            model_type="chat",
            tags=["general", "reasoning", "coding", "creative", "analysis"],
    ...
    "kimi-code:kimi/kimi-for-coding": ModelCapabilities(
        model_id="kimi-code:kimi/kimi-for-coding",
        backend_type="kimi-code",
        metadata=ModelMetadata(
            name="kimi-for-coding",
            display_name="Kimi For Coding",
            description="Kimi coding model (OpenAI-compatible) via Kimi Code backend",
            provider="Kimi",
            model_type="chat",
            tags=["coding", "multimodal", "vision", "reasoning"],
        ),
        capabilities=[
            ModelCapability.CHAT,
            ModelCapability.VISION,
    ...
    "kimi/kimi-for-coding": ModelCapabilities(
        model_id="kimi/kimi-for-coding",
        backend_type="kimi-code",
        metadata=ModelMetadata(
            name="kimi/kimi-for-coding",
            display_name="Kimi For Coding",
            description="Kimi coding model (OpenAI-compatible) via Kimi Code backend",
            provider="Kimi",
            model_type="chat",
    ...
    "glm-4.6": ModelCapabilities(
        ...
        metadata=ModelMetadata(
            name="glm-4.6",
            display_name="GLM 4.6 (ZAI Coding Plan)",
            description="Zhipu's GLM 4.6 model available via ZAI coding plan",
            provider="ZAI",
            version="4.6",
            model_type="chat",
            tags=["general", "reasoning", "coding", "analysis"],
        ),
        capabilities=[
            ModelCapability.CHAT,
            ModelCapability.STREAMING,
    ...
    "claude-sonnet-4-20250514": ModelCapabilities(
        ...
        metadata=ModelMetadata(
            ...
            display_name="Claude Sonnet 4 (Legacy ZAI Coding Plan)",
            description="Legacy Anthropic Claude Sonnet model accessed via ZAI coding plan",
            provider="ZAI",
            version="20250514",
            model_type="chat",
            tags=["general", "reasoning", "coding", "legacy"],
        ),
        capabilities=[
            ModelCapability.CHAT,
            ModelCapability.STREAMING,
