...
class SessionStateBuilder:
    ...
    def with_backend_config(self, backend_config: BackendConfiguration) -> SessionStateBuilder:
    ...
    def with_reasoning_config(self, reasoning_config: ReasoningConfiguration) -> SessionStateBuilder:
    ...
    def with_loop_config(self, loop_config: LoopDetectionConfiguration) -> SessionStateBuilder:
    ...
    def with_project_config(self, project_config: ProjectConfiguration) -> SessionStateBuilder:
