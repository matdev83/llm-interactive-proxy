...
async def get_usage_stats(
    ...
    try:
        ...
        return _aggregated_stats_to_dict(stats)
...
def _aggregated_stats_to_dict(stats: AggregatedStats) -> dict[str, Any]:
    """Convert AggregatedStats to a dictionary for JSON response.
