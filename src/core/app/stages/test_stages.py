        ...
        async def mock_chat_completions(
            *args: Any, **kwargs: Any
            ...
            if has_tools:
                ...
                if request and hasattr(request, "extra_body") and request.extra_body:
                ...
                if json_schema:
                    ...
                    def generate_mock_value(
                        ...
                        if prop_type == "string":
                            ...
                            return f"Mock {prop_name}" if prop_name else "Mock string"
                            ...
                            return f"mock {prop_name}" if prop_name else "mock value"
            ...
            response_data = {
                ...
                "created": 1234567890,
                "model": (
                    getattr(request, "model", "mock-model") if request else "mock-model"
                ),
                "choices": [
                    {
                        "index": 0,
            ...
            if stream_value:
                ...
                if logger.isEnabledFor(logging.INFO):
                    logger.info("Created streaming envelope: %s", streaming_envelope)
        ...
        async def _call_completion_delegate(*args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                if backend_type in ("anthropic", "openai-codex"):
                    ...
                    real_backend = await mock_backend_service._get_or_create_backend(
                        backend_type
                    )
