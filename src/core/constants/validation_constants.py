...
VALIDATION_MUST_BE_INTEGER_MESSAGE = "Invalid {field} value: {value}. Must be an integer."
...
VALIDATION_MUST_BE_BETWEEN_MESSAGE = "{field} must be between {min_value} and {max_value}"
...
COMMAND_PREFIX_MUST_BE_AT_LEAST_CHARS_MESSAGE = "command prefix must be at least {min_chars} characters"
COMMAND_PREFIX_MUST_NOT_EXCEED_CHARS_MESSAGE = "command prefix must not exceed {max_chars} characters"
COMMAND_PREFIX_MUST_CONTAIN_PRINTABLE_CHARS_MESSAGE = "command prefix must contain only printable characters"
COMMAND_PREFIX_MUST_BE_NON_EMPTY_STRING_MESSAGE = "command prefix must be a non-empty string"

TEMPERATURE_MUST_BE_BETWEEN_MESSAGE = "Temperature must be between {min_temp} and {max_temp}"
