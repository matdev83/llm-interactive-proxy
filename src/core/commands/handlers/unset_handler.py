        ...
        for param in params:
            ...
            if param_lower in self._handlers:
                ...
                try:
                    if param_lower == "model" or param_lower == "backend_model":
                    ...
                    elif param_lower == "interactive" or param_lower == "interactive-mode":
                        builder.with_backend_config(
                        ...
                        builder.with_reasoning_config(
                            current_state.reasoning_config.with_gemini_generation_config(None)
                        )
                        ...
                        builder.with_loop_config(
                            current_state.loop_config.with_tool_loop_detection_enabled(True)
                        )
                        ...
                        if context and hasattr(context, "app") and context.app:
                            ...
                            results.append(f"Command prefix reset to {DEFAULT_COMMAND_PREFIX}")
                        else:
                            results.append("Cannot unset command prefix without app context")
                            success = False
