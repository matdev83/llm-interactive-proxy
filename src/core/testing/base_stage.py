...
class ValidatedTestStage(InitializationStage):
    ...
    def safe_register_singleton(
        ...
        if implementation_factory:
            services.add_singleton(service_type, implementation_factory=implementation_factory)
        elif implementation_type:
            services.add_singleton(service_type, implementation_type=implementation_type)
        else:
