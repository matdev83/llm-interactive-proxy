...
def apply_cli_args(
    ...
    *,
    ...
    """
    # Backward-compatible wrapper: keep legacy behavior stable while the
    # ConfigurationApplicator refactor progresses.
    return _apply_cli_args_legacy(
        args, return_resolution=return_resolution, resolution=resolution
    )
...
# ============================================================================
# Legacy _handle_application_build_error implementation preserved for reference
# (Now handled by ErrorHandler)
# ============================================================================


def _handle_application_build_error_legacy(error_msg: str) -> None:
    """Legacy implementation preserved for reference - DO NOT USE.

    This function preserves the original implementation for reference.
    All new code should use _handle_application_build_error() which delegates
    to ErrorHandler.
    """
    import sys
