...
class AppSettings(IAppSettings):
    ...
    def _initialize_from_app_state(self, app_state: Any) -> None:
        ...
        try:
            ...
            if hasattr(app_state, "failover_routes"):
                self._settings["failover_routes"] = getattr(app_state, "failover_routes")
                
            # Extract command prefix
            if hasattr(app_state, "command_prefix"):
                self._settings["command_prefix"] = getattr(app_state, "command_prefix")
                
            # Extract redact API keys
            if hasattr(app_state, "redact_api_keys"):
                self._settings["redact_api_keys"] = getattr(app_state, "redact_api_keys")
                
            # Extract disable interactive commands
            if hasattr(app_state, "disable_interactive_commands"):
                self._settings["disable_interactive_commands"] = getattr(
    ...
    def get_failover_routes(self) -> Optional[List[Dict[str, Any]]]:
        ...
        """
        return self.get_setting("failover_routes")
    ...
    def get_command_prefix(self) -> str:
        ...
        Returns:
            The command prefix
        """
        return self.get_setting("command_prefix", "!")
    ...
    def get_redact_api_keys(self) -> bool:
        ...
        """
        return self.get_setting("redact_api_keys", True)
    ...
    def get_disable_interactive_commands(self) -> bool:
        ...
        """
        return self.get_setting("disable_interactive_commands", False)
