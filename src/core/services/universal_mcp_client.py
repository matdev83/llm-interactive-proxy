...
class UniversalMCPClient:
    ...
    async def _discover_server_tools(self, server_name: str) -> None:
        ...
        try:
            ...
            for tool_def in discovered_tools:
                ...
                logger.debug(f"Discovered MCP tool: {tool_name} from server {server_name}")
    ...
    async def execute_tool(self, tool_name: str, arguments: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            logger.debug(f"Executing MCP tool '{tool_name}' on server '{server_name}' with arguments: {arguments}")
    ...
    async def _send_tool_call(self, server_name: str, tool_name: str, arguments: dict[str, Any]) -> dict[str, Any]:
    ...
    async def disconnect_server(self, server_name: str) -> None:
        ...
        try:
            if server_name in self._connected_servers:
                ...
                tools_to_remove = [
                    tool_name for tool_name, srv_name in self._tool_to_server_map.items()
