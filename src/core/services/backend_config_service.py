...
class BackendConfigService:
    ...
    def _apply_gemini_config(self, request: ChatCompletionRequest) -> ChatCompletionRequest:
        ...
        if request.generation_config:
            try:
                gemini_config = gemini_config.with_generation_config(request.generation_config)
    ...
    def _apply_openai_config(self, request: ChatCompletionRequest) -> ChatCompletionRequest:
