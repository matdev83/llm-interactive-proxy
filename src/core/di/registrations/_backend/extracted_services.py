...
def register_extracted_backend_services(services: ServiceCollection) -> None:
    ...
    register_singleton_if_absent(
        ...
        implementation_factory=lambda p: p.get_required_service(URIParameterApplicator),
    )
    ...
    register_singleton_if_absent(
        ...
        implementation_factory=lambda p: p.get_required_service(ExceptionNormalizer),
    )
    ...
    register_singleton_if_absent(
        ...
        implementation_factory=lambda p: p.get_required_service(UsageTrackingWrapper),
    )
