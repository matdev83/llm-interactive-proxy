...
class ICodexContinuationCoordinator(ABC):
    """Interface for Codex continuation lineage handling.

    This is an internal contract for future delta-path orchestration.
    """
