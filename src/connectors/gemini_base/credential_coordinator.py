...
class CredentialStorageAdapter:
    ...
    def _oauth_credentials(self) -> dict[str, Any] | None:
        ...
        if self._coordinator._credentials:
            return self._coordinator._credentials.to_dict()
        return None
...
class CredentialProviderAdapter:
    ...
    async def _load_oauth_credentials(
        ...
        return await self._coordinator._load_credentials_internal(
...
class GeminiCredentialCoordinator(ICredentialCoordinator):
    ...
    def __init__(
        ...
        self._gemini_cli_oauth_path: str | None = None
    ...
    async def _handle_credentials_file_change(self) -> None:
        ...
        try:
            ...
            if await self._load_credentials_internal(force_reload=True, silent=True):
                if (
    ...
    async def _load_credentials_internal(
        self, force_reload: bool = False, silent: bool = False
    ) -> bool:
