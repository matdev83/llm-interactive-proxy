    ...
    try:
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "user",
                    "content": "Hello! Please confirm you are receiving this message from OpenRouter. Be brief.",
                }
            ],
            temperature=0.7,
            max_tokens=100,
        ...
        if "User not found" in str(e):
            ...
            print(
                "Please ensure the 'OPENROUTER_API_KEY' environment variable is set for the proxy server process."
            )
        else:
