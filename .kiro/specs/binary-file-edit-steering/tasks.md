...
- [ ] 1. Implement BinaryFileEditPolicy core
  - [ ] 1.1 Create binary_file_edit_policy.py with ISteeringPolicy implementation
  ...
  - [ ] 1.2 Write property test for binary extension detection
    - **Property 1: Binary extensions trigger steering**
    - **Validates: Requirements 1.1**

  - [ ] 1.3 Write property test for non-binary extension pass-through
    - **Property 2: Non-binary extensions pass through**
    - **Validates: Requirements 1.2**

  - [ ] 1.4 Write property test for disabled policy behavior
    - **Property 3: Disabled policy returns None**
    - **Validates: Requirements 1.3**

  - [ ] 1.5 Write property test for path extraction
    - **Property 4: Path extraction from various parameter names**
    - **Validates: Requirements 1.5**

  - [ ] 1.6 Write property test for case-insensitive matching
    - **Property 5: Case-insensitive extension matching**
    - **Validates: Requirements 2.10**

- [ ] 2. Add configuration support
  - [ ] 2.1 Add config fields to AppConfig
  ...
  - [ ] 2.2 Add CLI flag for disabling the feature
    - Add `--disable-binary-file-edit-steering` argument to `argument_parser_builder.py`
    - _Requirements: 3.1_

  - [ ] 2.3 Add applicator logic for CLI flag
...
- [ ] 3. Register policy in SteeringStage
  - [ ] 3.1 Update SteeringStage to register BinaryFileEditPolicy
  ...
  - [ ] 3.2 Write unit tests for policy registration
...
- [ ] 5. Write comprehensive unit tests
  - [ ] 5.1 Write unit tests for binary extension categories
  ...
  - [ ] 5.2 Write unit tests for file path extraction
  ...
  - [ ] 5.3 Write unit tests for tool recognition
