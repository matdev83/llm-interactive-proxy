...
- [ ] 1. Solidify public boundaries and configuration seams
- [ ] 1.1 (P) Centralize Codex request execution configuration in the response execution component
...
- [ ] 1.2 (P) Make compatibility collaborator boundaries explicit and typed
...
- [ ] 1.3 Validate dependency overrides and fail fast on invalid injections
...
- [ ] 1.4 Preserve credential lifecycle ownership and concurrency behavior during refactor
...
- [ ] 2. Converge Codex execution to a single path through the response execution component
- [ ] 2.1 Remove duplicated connector-side Codex network execution and retry logic
...
- [ ] 2.2 Preserve non-Codex dispatch behavior and backend gating semantics
...
- [ ] 2.3 Preserve compatibility state propagation and formatting behavior across the single path
...
- [ ] 2.4 Ensure request preparation remains isolated and behavior-compatible
...
- [ ] 3. Preserve compatibility flows and tool execution semantics
- [ ] 3.1 Maintain tool translation and tool execution result formatting
...
- [ ] 3.2 Preserve streaming translation ordering and termination under retries
...
- [ ] 3.3 Guarantee per-request compatibility cleanup for all outcomes
...
- [ ] 4. Maintain DI, staged initialization, and observability/capture continuity
- [ ] 4.1 Preserve DI wiring behavior for partial dependency bundles
...
- [ ] 4.2 Preserve backend registration stability
...
- [ ] 4.3 Preserve envelopes, usage metadata, logging, and redaction behavior
...
- [ ] 5. Update and extend tests to lock in non-regression and new public seams
- [ ] 5.1 Refactor unit tests to use stable configuration seams (no private field mutation)
...
- [ ] 5.2 Extend integration tests to validate the single execution path and parity
...
- [ ] 6. Run verification gates and fix regressions
- [ ] 6.1 Run focused Codex suites and project-wide checks, and fix failures
