...
- [ ] 1. Define shared contracts and context translation
- [ ] 1.1 Define component interfaces and typed processing context models for the new request/response components
...
- [ ] 1.2 Implement middleware context translation helper for streaming and non-streaming paths
...
- [ ] 2. Build request preparation component
- [ ] 2.1 (P) Write unit tests for request preparation behavior
...
- [ ] 2.2 Implement request preparation logic with optional collaborators
...
- [ ] 3. Build tool-call retry coordinator
- [ ] 3.1 (P) Write unit tests for tool-call retry coordination across streaming and non-streaming
...
- [ ] 3.2 Implement tool-call retry coordination and metadata propagation
...
- [ ] 4. Build non-streaming response handling and structured output enforcement
- [ ] 4.1 (P) Write unit tests for non-streaming response processing
...
- [ ] 4.2 Implement structured output enforcement with feature-first wiring
...
- [ ] 4.3 Implement non-streaming response handler and retry integration
...
- [ ] 5. Build streaming response handling and safety components
- [ ] 5.1 (P) Write unit tests for streaming response handling and safety
...
- [ ] 5.2 Implement loop detection factory and Angel verification with fail-open behavior
...
- [ ] 5.3 Implement streaming response handler integration
...
- [ ] 6. Integrate orchestrator and DI wiring
- [ ] 6.1 Update backend request manager orchestration to delegate to components and preserve contracts
...
- [ ] 6.2 Wire orchestration error paths and optional collaborator safety
...
- [ ] 6.3 Register new components and structured output feature wiring in DI
...
- [ ] 7.1 Write or update integration tests for request/response flows
...
- [ ] 7.2 Run targeted unit and integration suites and resolve failures
