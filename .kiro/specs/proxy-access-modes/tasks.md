...
- [ ] 1. Create access mode configuration models
- [ ] 1.1 Create AccessMode enum and AccessModeConfig model
...
- [ ] 1.2 Integrate AccessModeConfig into AppConfig
...
- [ ] 1.3 Write unit tests for access mode configuration models
...
- [ ] 2. Add CLI flags for access mode selection
- [ ] 2.1 Add access mode flags to ArgumentParserBuilder
...
- [ ] 2.2 Add access mode validation to CliArgsValidator
...
- [ ] 2.3 Write unit tests for CLI argument parsing and validation
...
- [ ] 3. Create access mode applicator for configuration
- [ ] 3.1 Create AccessModeApplicator in cli_support/applicators
...
- [ ] 3.2 Integrate AccessModeApplicator into ConfigurationApplicator
...
- [ ] 3.3 Write unit tests for AccessModeApplicator
  - Test CLI flag overrides config file
  - Test default mode when no flag specified
  - Test parameter resolution tracking
  - _Requirements: 1.2, 1.3_

- [ ] 4. Create AccessModeValidator service
- [ ] 4.1 Create IAccessModeValidator interface
...
- [ ] 4.2 Implement AccessModeValidator service
...
- [ ] 4.3 Write unit tests for AccessModeValidator
...
- [ ] 4.4 Write property test for Single User Mode localhost enforcement
...
- [ ] 4.5 Write property test for Multi User Mode auth enforcement
...
- [ ] 4.6 Write property test for Multi User Mode non-localhost with auth
...
- [ ] 4.7 Write property test for Multi User Mode OAuth flag blocking
...
- [ ] 4.8 Write property test for error message quality
...
- [ ] 4.9 Write property test for error message CLI flag references
...
- [ ] 4.10 Write property test for validation exit codes
...
- [ ] 5. Integrate AccessModeValidator into startup sequence
- [ ] 5.1 Add validation call to ServerLifecycleManager
...
- [ ] 6. Implement OAuth connector filtering
- [ ] 6.1 Create OAuth connector detection utilities
...
- [ ] 6.2 Enhance connector auto-discovery with OAuth filtering
...
- [ ] 6.3 Write unit tests for OAuth connector detection
...
- [ ] 6.4 Write integration tests for OAuth connector filtering
...
- [ ] 8.3 Create access mode user guide
  - Create `docs/user_guide/access_modes.md`
