...
- [ ] 1. Build safety net for boundaries and invariants
- [ ] 1.1 Add automated checks preventing transport-layer dependencies in orchestration code
...
- [ ] 1.2 Add characterization tests for domain-error normalization and auth failure semantics
...
- [ ] 1.3 Add characterization tests for capture and usage invariants in error and streaming paths
...
- [ ] 2. Define collaborator contracts and DI strategy
- [ ] 2.1 Define focused interfaces for orchestration collaborators
...
- [ ] 2.2 Update DI wiring to construct orchestration from interfaces
...
- [ ] 3. Implement focused collaborators with unit tests
- [ ] 3.1 (P) Implement availability gating collaborator
...
- [ ] 3.2 (P) Implement wire-capture orchestration collaborator
...
- [ ] 3.3 (P) Implement usage accounting collaborator
...
- [ ] 3.4 Implement failure recovery execution collaborator
...
- [ ] 3.5 Implement request preparation and session resolution collaborators
...
- [ ] 4. Refactor orchestration coordinator and remove coupling
- [ ] 4.1 Refactor the orchestration entrypoint into a coordinator that delegates to collaborators
...
- [ ] 4.2 Remove transport/framework exceptions from core orchestration
...
- [ ] 4.3 Remove production-only test compatibility shims and private-method patching reliance
...
- [ ] 4.4 Remove dead scaffolding and private reach-through seams
...
- [ ] 5. Verify regressions and enforce maintainability gates
- [ ] 5.1 Run targeted unit and integration tests for the orchestration subsystem and fix regressions
  - Run focused collaborator unit tests first, then the full automated suite
  - _Requirements: 5.5_

- [ ] 5.2 Verify size/complexity gates with existing tooling and fix violations
...
- [ ] 5.3 Validate non-functional invariants (performance, reliability, security) remain non-regressive
...
- [ ] 5.4 Add an in-code responsibility map artifact and a test to keep boundaries stable
