...
- [x] 1. Establish a reliable baseline for current behavior
...
- [x] 1.1 (P) Add/extend characterization tests for target resolution
...
- [x] 1.2 (P) Add/extend characterization tests for failover planning and execution
...
- [x] 1.3 (P) Add/extend characterization tests for streaming session identity
...
- [x] 2. Define small interfaces for the new collaborators
...
- [x] 2.1 (P) Add DI wiring for new collaborators
...
- [x] 3. Implement the streaming session-id resolver and reuse it consistently
...
- [x] 3.1 (P) Implement target resolution as a dedicated service
...
- [x] 3.2 (P) Implement failover planning as a dedicated service
  - Extract plan selection and health filtering into a focused service, preserving all edge cases.
  - _Requirements: 7.1, 7.2_

- [x] 3.3 Implement completion orchestration as a dedicated service
...
- [x] 4. Remove runtime fallback instantiation from BackendService construction
...
- [x] 4.1 Update BackendService to delegate to new collaborators
