...
- [x] 1. Core EoS domain and configuration
- [x] 1.1 (P) Define backend-scoped EoS event and signal models with required metadata
...
- [x] 1.2 (P) Add End-of-Session configuration options and validation
...
- [x] 2. Persistence and idempotency foundation
- [x] 2.1 Update session metrics storage to record EoS fields and migrate data
...
- [x] 2.2 Add atomic claim and persistence behavior for EoS completion
...
- [x] 3. EoS detection and emission core
- [x] 3.1 Implement EndOfSessionService for gating, dedupe, and bounded dispatch
...
- [x] 3.2 Implement stream-based EoS detection across protocols and modes
...
- [x] 3.3 Implement tool-call completion detection
...
- [x] 3.4 Integrate backend and transport error termination signals
...
- [x] 4. Wiring and subscription lifecycle
- [x] 4.1 Wire EoS services into startup and processing pipelines
...
- [x] 4.2 Ensure listener dispatch isolation with correlation-aware logging
...
- [x] 5. Subsystem subscribers and legacy refactors
- [x] 5.1 (P) ProxyMem subscriber for EoS completion
  - Mark memory sessions complete and enqueue follow-up analysis on EoS.
  - Keep behavior idempotent for repeated signals.
  - _Requirements: 7.1_

- [x] 5.2 (P) Usage tracking subscriber and legacy detector removal
...
- [x] 5.3 (P) Wire capture subscriber and metadata updates
...
- [x] 5.4 (P) Test reminder subscriber and legacy detector removal
...
- [x] 6. Verification and tests
- [x] 6.1 Unit tests for EndOfSessionService idempotency and timeout behavior
...
- [x] 6.2 Unit tests for stream and tool-call signal normalization
...
- [x] 6.3 Unit tests for subscribers and listener isolation
...
- [x] 6.4 Integration tests for wiring and end-to-end emission
...
- [x] 6.5 Property tests for dedupe invariants
