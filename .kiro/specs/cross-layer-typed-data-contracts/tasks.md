...
- [ ] 1. Phase A: Make request context a typed, explicit contract
- [ ] 1.1 Add explicit typed fields to request context and remove reliance on dynamic attributes
...
- [ ] 1.2 Update transport-to-domain adaptation to populate typed context fields end-to-end
...
- [ ] 1.3 Migrate controllers and core services away from dynamic context attributes
...
- [ ] 1.4 Add characterization tests for request context propagation and behavior preservation
...
- [ ] 2. Phase A: Constrain extension payloads and reduce ad hoc dict usage at boundaries
- [ ] 2.1 Introduce a single, JSON-serializable extension container and use it consistently
...
- [ ] 2.2 Tighten target-resolution URI parameter typing to JSON-serializable values
...
- [ ] 2.3 Add type-checking guardrails for Phase A boundary changes
...
- [ ] 3. Phase A: Preserve immutability and streaming performance
- [ ] 3.1 Enforce copy-on-write mutation behavior for contract changes in the request pipeline
...
- [ ] 3.2 Validate streaming contract choices do not introduce buffering or regressions
...
- [ ] 4. Phase B primitives: Introduce canonical routing and usage contracts
- [ ] 4.1 (P) Introduce a canonical backend target contract and integrate it into target resolution outputs
...
- [ ] 4.2 (P) Introduce a canonical usage summary contract and integrate it into usage recording surfaces
...
- [ ] 4.3 Align backend completion collaborator boundaries to canonical contracts
...
- [ ] 5. Phase B+: Tighten backend completion and connector-facing boundary types
- [ ] 5.1 Replace collaborator interface `Any` signatures with canonical types and add compatibility shims where required
...
- [ ] 5.2 Make response envelope metadata and usage surfaces typed and JSON-serializable
...
- [ ] 5.3 Add integration tests for collaborator wiring and connector compatibility
...
- [ ] 6. (P) Capture and replay: Best-effort round-trip into canonical contracts
- [ ] 6.1 (P) Implement best-effort decoding of captured traffic into canonical request/response contracts for simulation
...
- [ ] 6.2 (P) Add tests for capture decoding determinism and round-trip invariants
...
- [ ] 7. (P) Contributor guidance and enforcement
- [ ] 7.1 (P) Add developer guidance describing canonical contracts and conversion points
...
- [ ] 7.2 (P) Add lightweight enforcement guardrails to prevent regression toward `Any` at boundaries
...
- [ ] 8. Final verification and regression safety
- [ ] 8.1 Run focused unit and integration suites for touched layers and fix regressions
...
- [ ] 8.2 Run formatting, linting, and type checking for touched modules
