...
async def test_live_backend():
    ...
    try:
        ...
        print("\n✅ SUCCESS: Request completed without 400 INVALID_ARGUMENT error!")
        ...
        print("\n" + "=" * 80)
        print("✅ VERIFICATION COMPLETE: Schema sanitization fix is working!")
        print("=" * 80)
        ...
        if "400" in error_str and "INVALID_ARGUMENT" in error_str:
            print("\n⚠️  The fix did NOT work - still getting 400 INVALID_ARGUMENT")
            print(
                "    This means the schema sanitization is not being applied correctly."
            )
        elif "403" in error_str or "Forbidden" in error_str:
            print("\n⚠️  Permission error - debugging override may not be set")
        else:
