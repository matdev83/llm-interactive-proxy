    ...
    def test_multiple_pings(self, client: TestClient) -> None:
        ...
        with client.websocket_connect("/ws") as websocket:
            ...
            websocket.send_json({
                "type": "identify",
                "txid": 1,
                "clientSessionId": "test-session-456"
            })
    ...
    def test_send_prompt_receive_chunks_and_response(
        ...
        with client.websocket_connect("/ws") as websocket:
            ...
            websocket.send_json({
                "type": "identify",
                "txid": 1,
                "clientSessionId": "test-session-789"
            })
            websocket.receive_json()  # ack
    ...
    def test_prompt_with_error(
        ...
        with client.websocket_connect("/ws") as websocket:
            ...
            websocket.send_json({
                "type": "identify",
                "txid": 1,
                "clientSessionId": "test-session-error"
            })
            websocket.receive_json()  # ack
    ...
    def test_init_action_stores_file_context(self, client: TestClient) -> None:
        ...
        with client.websocket_connect("/ws") as websocket:
            ...
            websocket.send_json({
                "type": "identify",
                "txid": 1,
                "clientSessionId": "test-session-init"
            })
            websocket.receive_json()  # ack
    ...
    def test_init_with_auth_token(self, client: TestClient) -> None:
        ...
        with client.websocket_connect("/ws") as websocket:
            ...
            websocket.send_json({
                "type": "identify",
                "txid": 1,
                "clientSessionId": "test-session-auth"
            })
            websocket.receive_json()  # ack
    ...
    def test_subscribe_and_unsubscribe(self, client: TestClient) -> None:
        ...
        with client.websocket_connect("/ws") as websocket:
            ...
            websocket.send_json({
                "type": "identify",
                "txid": 1,
                "clientSessionId": "test-session-sub"
            })
            websocket.receive_json()  # ack
    ...
    def test_disconnect_does_not_affect_other_connections(
        ...
        with client.websocket_connect("/ws") as ws1:
            ws1.send_json({
                "type": "identify",
                "txid": 1,
                "clientSessionId": "persistent-session"
            })
            ws1.receive_json()  # ack
