...
async def test_e2e_stream_detection_flags_next_call_and_tunes_request() -> None:
    ...
    shared_state.set_setting("app_config", app_config)
    ...
    pending = shared_state.get_setting("edit_precision_pending", {})
    ...
    pending_after = shared_state.get_setting("edit_precision_pending", {})
