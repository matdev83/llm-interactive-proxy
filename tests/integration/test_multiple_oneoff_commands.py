...
class TestMultipleOneoffCommands:
    ...
    def test_multiple_oneoff_commands_sequence(self, client: TestClient):
            ...
            "choices": [
                {
                    ...
                    "message": {
                        "role": "assistant",
                        "content": "Default OpenRouter response",
                    },
                    "finish_reason": "stop",
                }
            ],
        ...
        with patch.object(
            ...
            assert (
                "Default OpenRouter response"
                in response1_json["choices"][0]["message"]["content"]
            )
            ...
            response2 = client.post(
                ...
                json={
                    "messages": [
                        {
                            "role": "user",
                            "content": "!/oneoff(openrouter/cypher-alpha:free)",
                        }
                    ],
                    "model": "gemini-2.0-flash-exp",
                },
            ...
            assert (
                "One-off route set to openrouter/cypher-alpha:free"
                in response2_json["choices"][0]["message"]["content"]
            )
            ...
            assert (
                "Cypher response" in response3_json["choices"][0]["message"]["content"]
            )
            ...
            response5 = client.post(
                ...
                json={
                    "messages": [
                        {
                            "role": "user",
                            "content": "!/oneoff(openrouter/mistralai/mistral-7b-instruct:free)",
                        }
                    ],
                    "model": "gemini-2.0-flash-exp",
                },
            ...
            assert (
                "One-off route set to openrouter/mistralai/mistral-7b-instruct:free"
                in response5_json["choices"][0]["message"]["content"]
            )
            ...
            assert (
                "Mistral response" in response6_json["choices"][0]["message"]["content"]
            )
    ...
    def test_oneoff_command_with_prompt_in_same_message(self, client: TestClient):
        ...
        with patch.object(
            ...
            assert (
                "Mocked response" in response_json["choices"][0]["message"]["content"]
            )
