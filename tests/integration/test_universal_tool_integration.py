...
class TestUniversalToolIntegration:
    ...
    async def test_list_files_alias_command_execution(
        self, command_context, temp_workspace
    ):
    ...
    async def test_completion_marker_command_execution(
        self, command_context, temp_workspace
    ):
    ...
    async def test_attempt_completion_alias_command_execution(
        self, command_context, temp_workspace
    ):
    ...
    async def test_followup_marker_command_execution(
        self, command_context, temp_workspace
    ):
    ...
    async def test_use_mcp_tool_command_execution(
        self, command_context, temp_workspace
    ):
        ...
        command = Command(
            name="use_mcp_tool",
            args={"tool_name": "test_tool", "arguments": '{"key": "value"}'},
        )
        result = await command_service.execute_command(command, command_context)
    ...
    async def test_unknown_tool_command_execution(
        self, command_context, temp_workspace
    ):
    ...
    async def test_command_with_missing_arguments(
        self, command_context, temp_workspace
    ):
