...
class TestOpenAISSEBufferOverflowDoSRegression:
    ...
    async def test_buffer_truncation_works(self) -> None:
        ...
        buffer_sizes = await self.vulnerable_sse_processing_simulation(large_chunk_stream())
    ...
    async def test_normal_sse_streams_work(self) -> None:
        ...
        buffer_sizes = await self.vulnerable_sse_processing_simulation(normal_sse_stream())
    ...
    def test_max_buffer_size_constant(self) -> None:
        ...
        assert MAX_SSE_BUFFER_SIZE == 16384, (
