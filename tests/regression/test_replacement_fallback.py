...
async def test_fallback_to_original_on_replacement_error():
    ...
    mock_replacement.get_effective_backend_model.return_value = ("replacement-backend", "replacement-model")
    ...
    mock_dependencies["transform_pipeline"].transform = AsyncMock(return_value=request_data)
    ...
    print("Test passed: Automatically fell back to original model after replacement failure.")
