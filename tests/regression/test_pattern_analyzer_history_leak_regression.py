...
class TestPatternAnalyzerHistoryLeakRegression:
    ...
    def test_history_truncated_when_exceeds_limit(self, analyzer: PatternAnalyzer) -> None:
    ...
    def test_history_not_truncated_below_limit(self, analyzer: PatternAnalyzer) -> None:
        ...
        assert len(analyzer.history) == num_events, (
    ...
    def test_history_oldest_events_removed(self, analyzer: PatternAnalyzer) -> None:
        ...
        if analyzer.history:
            ...
            assert first_event.pattern != "Pattern0", (
                "Oldest events should be removed during truncation"
            )

    def test_history_truncation_called_on_detection(self, analyzer: PatternAnalyzer) -> None:
