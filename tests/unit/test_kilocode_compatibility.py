...
class TestKiloCodeDetection:
    ...
    def test_kilocode_detection_case_insensitive(self):
        ...
        test_cases = ["KiloCode", "KILOCODE", "kilocode", "Kilo-Code", "kilo_code", "kilocode.ai"]
    ...
    def test_non_kilocode_agents_unchanged(self):
        ...
        for agent_name in test_cases:
            ...
            assert capabilities.tool_text_format != "codex_xml" or capabilities.tool_text_format == "none"
