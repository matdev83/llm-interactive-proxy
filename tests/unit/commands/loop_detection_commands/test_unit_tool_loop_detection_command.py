...
async def test_tool_loop_detection_enable(
    command: ToolLoopDetectionCommand, mock_session: Mock
):
    # Arrange
    args = {"enabled": "true"}
...
async def test_tool_loop_detection_disable(
    command: ToolLoopDetectionCommand, mock_session: Mock
):
    # Arrange
...
async def test_tool_loop_detection_default_enables(
    command: ToolLoopDetectionCommand, mock_session: Mock
):
    # Arrange
    args = {}
