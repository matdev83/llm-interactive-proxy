...
class TestAnthropicFrontendAccounting:
    ...
    def test_extract_billing_info_from_headers_anthropic(self):
        ...
        assert billing_info["provider_info"]["note"] == "Anthropic backend - usage info in response only"
    ...
    def test_streaming_response_billing(self):
        ...
        billing_info = extract_billing_info_from_response(streaming_response, "anthropic")
