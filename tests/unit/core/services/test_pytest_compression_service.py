...
========================= 1 failed, 2 passed in 0.12s ========================="""
    ...
    def test_apply_pytest_compression_with_pytest_command_enabled(
        ...
        result = agent_formatter._apply_pytest_compression(
    ...
    def test_apply_pytest_compression_with_pytest_command_disabled(
    ...
    def test_apply_pytest_compression_with_non_pytest_command(
        self, agent_formatter, session_with_compression_enabled
    ):
    ...
    def test_apply_pytest_compression_with_empty_message(
        self, agent_formatter, session_with_compression_enabled
    ):
    ...
    def test_apply_pytest_compression_with_none_message(
        self, agent_formatter, session_with_compression_enabled
    ):
    ...
    def test_format_command_result_for_cline_applies_compression(
        self, agent_formatter, session_with_compression_enabled
    ):
        ...
        with patch.object(
            ...
            agent_formatter.format_command_result_for_agent(
    ...
    def test_format_command_result_for_non_cline_applies_compression(
        self, agent_formatter, session_with_compression_enabled
    ):
