"""
Utility test doubles and data builders for unit tests.

This module provides test implementations of various services and data building
helpers that are not directly tied to core interfaces but are commonly used
