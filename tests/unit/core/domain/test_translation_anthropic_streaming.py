...
class TestAnthropicStreamingTranslation:
    ...
    def test_anthropic_sse_message_delta_stop(self):
        ...
        sse_chunk = 'data: {"type":"message_delta","delta":{"stop_reason":"end_turn"}}\n\n'
    ...
    def test_anthropic_sse_message_delta_max_tokens(self):
        ...
        sse_chunk = 'data: {"type":"message_delta","delta":{"stop_reason":"max_tokens"}}\n\n'
    ...
    def test_anthropic_sse_without_data_prefix(self):
        ...
        sse_chunk = '{"type":"content_block_delta","delta":{"type":"text_delta","text":"Test"}}'
    ...
    def test_anthropic_multiple_content_deltas(self):
        ...
        results = [Translation.anthropic_to_domain_stream_chunk(chunk) for chunk in chunks]
    ...
    def test_anthropic_tool_use_stop_reason(self):
        ...
        sse_chunk = 'data: {"type":"message_delta","delta":{"stop_reason":"tool_use"}}\n\n'
