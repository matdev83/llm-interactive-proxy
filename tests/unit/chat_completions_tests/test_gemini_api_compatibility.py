...
class TestGeminiModelsEndpoint:
    ...
    def test_list_models_gemini_format(self, client):
        ...
        with (
            patch.object(client.app.state, "openrouter_backend") as mock_or,
...
class TestGeminiGenerateContent:
    ...
    def test_generate_content_basic(self, client):
        ...
        client.app.state.disable_interactive_commands = (
            True  # Disable interactive commands for clean testing
        )
        ...
        request_data = {
            "contents": [{"parts": [{"text": "Hello, how are you?"}], "role": "user"}],
        ...
        with patch.object(
            ...
            response = client.post(
                "/v1beta/models/test-model:generateContent", json=request_data
            )
    ...
    def test_generate_content_with_system_instruction(self, client):
        ...
        with patch.object(
            ...
            assert "candidates" in data
            assert (
                data["candidates"][0]["content"]["parts"][0]["text"] == "2+2 equals 4."
            )
    ...
    def test_generate_content_error_handling(self, client):
        ...
        with patch.object(
            ...
            response = client.post(
                "/v1beta/models/invalid-model:generateContent", json=request_data
            )
...
class TestGeminiStreamGenerateContent:
    ...
    def test_stream_generate_content(self, client):
        ...
        request_data = {
            "contents": [
                {"parts": [{"text": "Tell me a short story"}], "role": "user"}
            ],
        ...
        mock_streaming_response = StreamingResponse(
            mock_stream(), media_type="text/plain; charset=utf-8"
        )
        ...
        with patch.object(
            ...
            response = client.post(
                "/v1beta/models/test-model:streamGenerateContent", json=request_data
            )
...
class TestGeminiAuthentication:
    ...
    def test_gemini_auth_with_api_key_header(self):
        ...
        response = client.get("/v1beta/models", headers={"x-goog-api-key": "wrong-key"})
    ...
    def test_gemini_auth_fallback_to_bearer(self):
        ...
        response = client.get(
            "/v1beta/models", headers={"Authorization": "Bearer test-api-key"}
        )
        assert response.status_code == 200
