...
from unittest.mock import AsyncMock, Mock, PropertyMock, MagicMock
...
class MockBackend:
    ...
    def __init__(self, client: httpx.AsyncClient, status_code: int = 200):
...
@pytest.fixture
def backend_service(mock_backend_factory, mock_backend, mock_rate_limiter, mock_config, mock_session_service):
...
@pytest.fixture
def backend_config(backend_type="openrouter", model="test-model"):
...
@pytest.fixture
def session_with_backend_config(test_session, backend_config):
