...
class MockBackend(LLMBackend):
    ...
    async def chat_completions(self, request_data, processed_messages, effective_model, identity=None, **kwargs):
...
def test_backend_retry_after_set_and_get(mock_backend):
...
def test_backend_retry_after_expiration(mock_backend):
...
def test_backend_retry_after_update(mock_backend):
...
def test_backend_retry_after_prevents_spam(mock_backend):
