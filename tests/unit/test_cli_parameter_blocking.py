...
class TestCLIParameterBlocking:
    ...
    def test_reasoning_effort_handler_works_normally_when_cli_thinking_budget_not_set(
        self,
    ):
    ...
    def test_thinking_budget_handler_works_normally_when_cli_thinking_budget_not_set(
        self,
    ):
    ...
    def test_reasoning_effort_handler_still_validates_when_cli_thinking_budget_set(
        self,
    ):
