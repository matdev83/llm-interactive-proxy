...
@pytest.mark.asyncio
async def test_chat_completions_rotates_on_project_permission_denied_backend_error() -> (
    None
):
    mock_client = MagicMock()
    mock_config = MagicMock()
...
@pytest.mark.asyncio
async def test_chat_completions_rotates_on_missing_project_id_backend_error() -> None:
    mock_client = MagicMock()
    mock_config = MagicMock()
    mock_config.get.return_value = False
    mock_config.backends = MagicMock()
...
@pytest.mark.asyncio
async def test_chat_completions_rotates_on_missing_project_id_without_current_account() -> (
    None
):
    mock_client = MagicMock()
    mock_config = MagicMock()
...
@pytest.mark.asyncio
async def test_chat_completions_rotates_on_missing_project_id_streaming_error() -> None:
    mock_client = MagicMock()
    mock_config = MagicMock()
    mock_config.get.return_value = False
    mock_config.backends = MagicMock()
...
@pytest.mark.asyncio
async def test_chat_completions_rotates_on_project_permission_denied_streaming_error() -> (
    None
):
    mock_client = MagicMock()
    mock_config = MagicMock()
