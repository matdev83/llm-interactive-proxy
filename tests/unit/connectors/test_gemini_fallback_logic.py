...
class TestGeminiFallbackLogic:
    def test_default_fallback_map_structure(self):
        ...
        assert DEFAULT_FALLBACK_MAP["gemini-3-pro"] == ["gemini-2.5-pro", "gemini-2.5-flash"]
        assert DEFAULT_FALLBACK_MAP["gemini-3-pro-high"] == ["gemini-2.5-pro", "gemini-2.5-flash"]
    ...
    async def test_connector_handle_429_fallback_chain(self):
        ...
        async def side_effect(request_data, processed_messages, effective_model, **kwargs):
