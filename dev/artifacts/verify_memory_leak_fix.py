...
def verify_no_memory_leak():
    ...
    for iteration in range(50):
        ...
        if iteration % 10 == 0:
            ...
            print(f"  Iteration {iteration}: primary={len(manager._cache)}, secondary={len(manager._by_tool_call)}, orphaned={orphaned}")
    ...
    if orphaned_count == 0 and mismatches == 0:
        ...
        print("All secondary index entries are properly synchronized with primary cache.")
        return True
    else:
