# Exception Hygiene Fix Task - Iteration 65/72
...
- **Line 1156** - EXH003: Silent exception handler (except: pass) with no logging

### File: `src\core\services\cbor_wire_capture_service.py`

- **Line 811** - EXH003: Silent exception handler (except: pass) with no logging

### File: `src\core\services\connector_invoker.py`

- **Line 218** - EXH003: Silent exception handler (except: pass) with no logging
