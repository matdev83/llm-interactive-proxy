# Exception Hygiene Fix Task - Iteration 38/72
...
- **Line 67** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\services\health\icmp_checker.py`

- **Line 128** - EXH001: Missing exc_info=True in logger call within exception handler
- **Line 192** - EXH001: Missing exc_info=True in logger call within exception handler
