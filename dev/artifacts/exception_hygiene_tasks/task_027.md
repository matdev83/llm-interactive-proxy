# Exception Hygiene Fix Task - Iteration 27/72
...
### File: `src\core\domain\translators\responses\streaming_parse.py`

- **Line 92** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\memory\analysis_worker.py`

- **Line 181** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\memory\service.py`

- **Line 412** - EXH001: Missing exc_info=True in logger call within exception handler
