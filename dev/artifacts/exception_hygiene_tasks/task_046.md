# Exception Hygiene Fix Task - Iteration 46/72
...
### File: `src\core\services\tool_call_reactor_service.py`

- **Line 400** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\services\translation_service.py`

- **Line 186** - EXH001: Missing exc_info=True in logger call within exception handler
- **Line 193** - EXH001: Missing exc_info=True in logger call within exception handler
