# Exception Hygiene Fix Task - Iteration 26/72
...
### File: `src\core\domain\streaming\parsing\processed_response_parser.py`

- **Line 158** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\domain\streaming\parsing\sse_bytes_parser.py`

- **Line 96** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\domain\translators\openai\streaming.py`

- **Line 80** - EXH001: Missing exc_info=True in logger call within exception handler
