# Exception Hygiene Fix Task - Iteration 52/72
...
- **Line 94** - EXH003: Silent exception handler (except: pass) with no logging

### File: `src\connectors\gemini_base\streaming_executor.py`

- **Line 596** - EXH003: Silent exception handler (except: pass) with no logging

### File: `src\connectors\gemini_base\token_manager.py`

- **Line 389** - EXH003: Silent exception handler (except: pass) with no logging
