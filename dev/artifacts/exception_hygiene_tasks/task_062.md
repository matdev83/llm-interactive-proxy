# Exception Hygiene Fix Task - Iteration 62/72
...
- **Line 174** - EXH003: Silent exception handler (except: pass) with no logging

### File: `src\core\domain\translators\gemini\request.py`

- **Line 62** - EXH003: Silent exception handler (except: pass) with no logging

### File: `src\core\domain\translators\gemini\streaming.py`

- **Line 173** - EXH003: Silent exception handler (except: pass) with no logging
