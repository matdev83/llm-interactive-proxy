# Exception Hygiene Fix Task - Iteration 4/72
...
- **Line 1407** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\connectors\gemini.py`

- **Line 173** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\connectors\gemini_base\connector.py`

- **Line 1230** - EXH001: Missing exc_info=True in logger call within exception handler
