# Exception Hygiene Fix Task - Iteration 69/72
...
- **Line 242** - EXH003: Silent exception handler (except: pass) with no logging

### File: `src\core\services\think_tags_fix_middleware.py`

- **Line 971** - EXH003: Silent exception handler (except: pass) with no logging

### File: `src\core\services\tool_call_loop_middleware.py`

- **Line 231** - EXH003: Silent exception handler (except: pass) with no logging
