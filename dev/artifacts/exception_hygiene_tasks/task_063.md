# Exception Hygiene Fix Task - Iteration 63/72
...
### File: `src\core\interfaces\tool_call_reactor_internal.py`

- **Line 131** - EXH003: Silent exception handler (except: pass) with no logging

### File: `src\core\memory\tool_event_collector.py`

- **Line 312** - EXH003: Silent exception handler (except: pass) with no logging

### File: `src\core\ports\streaming_orchestrator.py`

- **Line 120** - EXH003: Silent exception handler (except: pass) with no logging
