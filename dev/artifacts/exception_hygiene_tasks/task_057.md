# Exception Hygiene Fix Task - Iteration 57/72
...
- **Line 67** - EXH003: Silent exception handler (except: pass) with no logging
- **Line 143** - EXH003: Silent exception handler (except: pass) with no logging

### File: `src\core\app\stages\test_stages.py`

- **Line 149** - EXH003: Silent exception handler (except: pass) with no logging
