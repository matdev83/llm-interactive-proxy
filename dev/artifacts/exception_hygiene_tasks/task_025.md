# Exception Hygiene Fix Task - Iteration 25/72
...
### File: `src\core\domain\model_utils.py`

- **Line 152** - EXH001: Missing exc_info=True in logger call within exception handler
- **Line 169** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\domain\streaming\parsing\json_string_parser.py`
