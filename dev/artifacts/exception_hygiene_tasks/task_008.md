# Exception Hygiene Fix Task - Iteration 8/72
...
### File: `src\connectors\gemini_base\credential_coordinator.py`

- **Line 234** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\connectors\gemini_base\credential_providers\sqlite_provider.py`

- **Line 149** - EXH001: Missing exc_info=True in logger call within exception handler
- **Line 154** - EXH001: Missing exc_info=True in logger call within exception handler
