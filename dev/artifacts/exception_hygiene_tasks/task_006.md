# Exception Hygiene Fix Task - Iteration 6/72
...
- **Line 2117** - EXH001: Missing exc_info=True in logger call within exception handler
- **Line 2173** - EXH001: Missing exc_info=True in logger call within exception handler
- **Line 2453** - EXH001: Missing exc_info=True in logger call within exception handler
