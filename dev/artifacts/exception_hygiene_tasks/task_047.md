# Exception Hygiene Fix Task - Iteration 47/72
...
### File: `src\core\services\translation_service.py`

- **Line 393** - EXH001: Missing exc_info=True in logger call within exception handler
- **Line 421** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\services\unified_tool_security_handler.py`

- **Line 204** - EXH001: Missing exc_info=True in logger call within exception handler
