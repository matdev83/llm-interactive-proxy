# Exception Hygiene Fix Task - Iteration 20/72
...
### File: `src\core\app\application_builder.py`

- **Line 584** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\app\controllers\models_controller.py`

- **Line 396** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\app\controllers\responses_controller.py`

- **Line 702** - EXH001: Missing exc_info=True in logger call within exception handler
