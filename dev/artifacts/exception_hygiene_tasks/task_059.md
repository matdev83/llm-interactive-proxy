# Exception Hygiene Fix Task - Iteration 59/72
...
### File: `src\core\common\contract_serialization.py`

- **Line 76** - EXH003: Silent exception handler (except: pass) with no logging

### File: `src\core\common\logging_utils.py`

- **Line 451** - EXH003: Silent exception handler (except: pass) with no logging

### File: `src\core\di\container.py`

- **Line 506** - EXH003: Silent exception handler (except: pass) with no logging
