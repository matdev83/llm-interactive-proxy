# Exception Hygiene Fix Task - Iteration 21/72
...
### File: `src\core\app\controllers\responses_controller.py`

- **Line 709** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\app\middleware\assessment_middleware.py`

- **Line 171** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\app\middleware\sso_middleware_adapter.py`

- **Line 117** - EXH001: Missing exc_info=True in logger call within exception handler
