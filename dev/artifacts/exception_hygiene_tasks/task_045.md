# Exception Hygiene Fix Task - Iteration 45/72
...
### File: `src\core\services\tool_call_loop_middleware.py`

- **Line 332** - EXH001: Missing exc_info=True in logger call within exception handler
- **Line 717** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\services\tool_call_reactor\fixups\droid_path_fixup.py`

- **Line 164** - EXH001: Missing exc_info=True in logger call within exception handler
