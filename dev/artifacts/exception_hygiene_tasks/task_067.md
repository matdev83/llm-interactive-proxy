# Exception Hygiene Fix Task - Iteration 67/72
...
- **Line 160** - EXH003: Silent exception handler (except: pass) with no logging
- **Line 170** - EXH003: Silent exception handler (except: pass) with no logging

### File: `src\core\services\reasoning_config_applicator.py`

- **Line 95** - EXH003: Silent exception handler (except: pass) with no logging
