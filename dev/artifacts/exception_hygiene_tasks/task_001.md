# Exception Hygiene Fix Task - Iteration 1/72
...
### File: `src\connectors\_openai_codex_compatibility_errors.py`

- **Line 221** - EXH004: Incorrect exc_info usage: exc_info=include_stack_trace (should be exc_info=True)

### File: `src\connectors\_openai_codex_connector.py`

- **Line 1570** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\connectors\anthropic.py`

- **Line 585** - EXH001: Missing exc_info=True in logger call within exception handler
