# Exception Hygiene Fix Task - Iteration 51/72
...
### File: `src\connectors\gemini_base\credential_loader.py`

- **Line 254** - EXH003: Silent exception handler (except: pass) with no logging

### File: `src\connectors\gemini_base\orchestrator.py`

- **Line 97** - EXH003: Silent exception handler (except: pass) with no logging

### File: `src\connectors\gemini_base\retry_delay_parser.py`

- **Line 82** - EXH003: Silent exception handler (except: pass) with no logging
