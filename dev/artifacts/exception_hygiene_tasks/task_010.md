# Exception Hygiene Fix Task - Iteration 10/72
...
- **Line 369** - EXH001: Missing exc_info=True in logger call within exception handler
- **Line 700** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\connectors\hybrid_backend\orchestration\orchestrator.py`

- **Line 378** - EXH001: Missing exc_info=True in logger call within exception handler
