# Exception Hygiene Fix Task - Iteration 16/72
...
- **Line 630** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\connectors\qwen_oauth.py`

- **Line 253** - EXH001: Missing exc_info=True in logger call within exception handler
- **Line 680** - EXH001: Missing exc_info=True in logger call within exception handler
