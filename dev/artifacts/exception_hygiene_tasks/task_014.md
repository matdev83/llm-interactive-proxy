# Exception Hygiene Fix Task - Iteration 14/72
...
### File: `src\connectors\openai_codex\credentials.py`

- **Line 738** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\connectors\openai_codex\prompt.py`

- **Line 209** - EXH001: Missing exc_info=True in logger call within exception handler
- **Line 231** - EXH001: Missing exc_info=True in logger call within exception handler
