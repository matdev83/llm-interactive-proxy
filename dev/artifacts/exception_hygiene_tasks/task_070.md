# Exception Hygiene Fix Task - Iteration 70/72
...
- **Line 606** - EXH003: Silent exception handler (except: pass) with no logging

### File: `src\core\services\tool_call_repair_service.py`

- **Line 770** - EXH003: Silent exception handler (except: pass) with no logging
- **Line 1135** - EXH003: Silent exception handler (except: pass) with no logging
