# Exception Hygiene Fix Task - Iteration 29/72
...
- **Line 443** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\ports\anthropic_normalizer.py`

- **Line 320** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\ports\gemini_normalizer.py`

- **Line 123** - EXH001: Missing exc_info=True in logger call within exception handler
