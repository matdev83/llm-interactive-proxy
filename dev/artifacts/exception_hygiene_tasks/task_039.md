# Exception Hygiene Fix Task - Iteration 39/72
...
### File: `src\core\services\in_memory_usage_store.py`

- **Line 257** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\services\json_repair_service.py`

- **Line 159** - EXH001: Missing exc_info=True in logger call within exception handler
- **Line 189** - EXH001: Missing exc_info=True in logger call within exception handler
