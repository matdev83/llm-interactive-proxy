# Exception Hygiene Fix Task - Iteration 5/72
...
### File: `src\connectors\gemini_base\connector.py`

- **Line 1247** - EXH001: Missing exc_info=True in logger call within exception handler
- **Line 1826** - EXH001: Missing exc_info=True in logger call within exception handler
- **Line 1971** - EXH001: Missing exc_info=True in logger call within exception handler
