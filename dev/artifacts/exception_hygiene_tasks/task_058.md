# Exception Hygiene Fix Task - Iteration 58/72
...
### File: `src\core\app\test_utils.py`

- **Line 39** - EXH003: Silent exception handler (except: pass) with no logging

### File: `src\core\cli_support\server_lifecycle_manager.py`

- **Line 330** - EXH003: Silent exception handler (except: pass) with no logging

### File: `src\core\common\command_args.py`

- **Line 38** - EXH003: Silent exception handler (except: pass) with no logging
