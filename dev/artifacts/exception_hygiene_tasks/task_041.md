# Exception Hygiene Fix Task - Iteration 41/72
...
### File: `src\core\services\path_validation_service.py`

- **Line 176** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\services\rate_limiter.py`

- **Line 517** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\services\request_transform_pipeline.py`

- **Line 346** - EXH001: Missing exc_info=True in logger call within exception handler
