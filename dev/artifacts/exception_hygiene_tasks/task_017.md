# Exception Hygiene Fix Task - Iteration 17/72
...
- **Line 824** - EXH001: Missing exc_info=True in logger call within exception handler
- **Line 1222** - EXH001: Missing exc_info=True in logger call within exception handler
- **Line 1497** - EXH001: Missing exc_info=True in logger call within exception handler
