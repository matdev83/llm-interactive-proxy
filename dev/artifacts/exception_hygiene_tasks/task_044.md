# Exception Hygiene Fix Task - Iteration 44/72
...
### File: `src\core\services\tool_access_policy_service.py`

- **Line 105** - EXH001: Missing exc_info=True in logger call within exception handler
- **Line 116** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\services\tool_call_handlers\droid_antigravity_path_fix_handler.py`

- **Line 239** - EXH001: Missing exc_info=True in logger call within exception handler
