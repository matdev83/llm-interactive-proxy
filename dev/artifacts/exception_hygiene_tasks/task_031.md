# Exception Hygiene Fix Task - Iteration 31/72
...
- **Line 382** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\services\angel_prompt_loader.py`

- **Line 124** - EXH001: Missing exc_info=True in logger call within exception handler
- **Line 148** - EXH001: Missing exc_info=True in logger call within exception handler
