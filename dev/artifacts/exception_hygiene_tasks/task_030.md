# Exception Hygiene Fix Task - Iteration 30/72
...
### File: `src\core\ports\gemini_normalizer.py`

- **Line 321** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\ports\openai_normalizer.py`

- **Line 87** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\ports\streaming_integration.py`

- **Line 198** - EXH001: Missing exc_info=True in logger call within exception handler
