# Exception Hygiene Fix Task - Iteration 33/72
...
### File: `src\core\services\assessment_prompt_loader.py`

- **Line 214** - EXH001: Missing exc_info=True in logger call within exception handler
- **Line 242** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\services\assessment_service.py`
