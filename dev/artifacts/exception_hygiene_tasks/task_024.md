# Exception Hygiene Fix Task - Iteration 24/72
...
### File: `src\core\di\registration_helpers\core_foundational.py`

- **Line 294** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\di\registrations\_backend\infrastructure.py`

- **Line 46** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\di\registrations\_resilience_backend_flow.py`

- **Line 501** - EXH001: Missing exc_info=True in logger call within exception handler
