# Exception Hygiene Fix Task - Iteration 18/72
...
- **Line 1505** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\connectors\zai_coding_plan.py`

- **Line 322** - EXH001: Missing exc_info=True in logger call within exception handler
- **Line 401** - EXH001: Missing exc_info=True in logger call within exception handler
