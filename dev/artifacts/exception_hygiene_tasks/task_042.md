# Exception Hygiene Fix Task - Iteration 42/72
...
### File: `src\core\services\session_metrics_initializer.py`

- **Line 96** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\services\streaming\json_repair_processor.py`

- **Line 241** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\services\structured_output_middleware.py`

- **Line 181** - EXH001: Missing exc_info=True in logger call within exception handler
