# Exception Hygiene Fix Task - Iteration 11/72
...
- **Line 608** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\connectors\mixins\antigravity_auth_mixin.py`

- **Line 233** - EXH001: Missing exc_info=True in logger call within exception handler
