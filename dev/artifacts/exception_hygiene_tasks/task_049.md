# Exception Hygiene Fix Task - Iteration 49/72
...
- **Line 482** - EXH001: Missing exc_info=True in logger call within exception handler
- **Line 529** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\testing\base_stage.py`

- **Line 165** - EXH001: Missing exc_info=True in logger call within exception handler
