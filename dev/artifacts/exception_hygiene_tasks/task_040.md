# Exception Hygiene Fix Task - Iteration 40/72
...
### File: `src\core\services\json_repair_service.py`

- **Line 351** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\services\model_alias_resolver.py`

- **Line 81** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\services\model_replacement_service.py`

- **Line 104** - EXH001: Missing exc_info=True in logger call within exception handler
