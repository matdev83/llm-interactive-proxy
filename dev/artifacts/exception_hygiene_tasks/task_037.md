# Exception Hygiene Fix Task - Iteration 37/72
...
### File: `src\core\services\end_of_session_service.py`

- **Line 304** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\services\event_bus.py`

- **Line 410** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\services\feature_parity_registration.py`

- **Line 60** - EXH001: Missing exc_info=True in logger call within exception handler
