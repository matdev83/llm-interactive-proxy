# Exception Hygiene Fix Task - Iteration 28/72
...
- **Line 553** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\persistence.py`

- **Line 168** - EXH001: Missing exc_info=True in logger call within exception handler
- **Line 429** - EXH001: Missing exc_info=True in logger call within exception handler
