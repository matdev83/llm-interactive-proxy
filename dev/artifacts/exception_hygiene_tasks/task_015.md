# Exception Hygiene Fix Task - Iteration 15/72
...
### File: `src\connectors\openai_codex\settings.py`

- **Line 296** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\connectors\openai_codex\utils.py`

- **Line 73** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\connectors\opencode_zen.py`

- **Line 507** - EXH001: Missing exc_info=True in logger call within exception handler
