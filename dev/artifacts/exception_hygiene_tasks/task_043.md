# Exception Hygiene Fix Task - Iteration 43/72
...
- **Line 449** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\services\tool_access_policy_service.py`

- **Line 82** - EXH001: Missing exc_info=True in logger call within exception handler
- **Line 93** - EXH001: Missing exc_info=True in logger call within exception handler
