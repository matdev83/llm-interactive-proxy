# Exception Hygiene Fix Task - Iteration 48/72
...
### File: `src\core\services\unified_tool_security_handler.py`

- **Line 216** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\services\uri_parameter_validator.py`

- **Line 122** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\core\services\wire_capture_service.py`

- **Line 434** - EXH001: Missing exc_info=True in logger call within exception handler
