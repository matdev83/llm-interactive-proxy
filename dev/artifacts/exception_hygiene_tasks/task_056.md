# Exception Hygiene Fix Task - Iteration 56/72
...
### File: `src\core\app\controllers\anthropic_controller.py`

- **Line 673** - EXH003: Silent exception handler (except: pass) with no logging

### File: `src\core\app\controllers\chat_controller.py`

- **Line 1045** - EXH003: Silent exception handler (except: pass) with no logging

### File: `src\core\app\controllers\responses_controller.py`

- **Line 284** - EXH003: Silent exception handler (except: pass) with no logging
