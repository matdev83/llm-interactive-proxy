# Exception Hygiene Fix Task - Iteration 61/72
...
### File: `src\core\domain\configuration\assessment_config.py`

- **Line 200** - EXH003: Silent exception handler (except: pass) with no logging
- **Line 207** - EXH003: Silent exception handler (except: pass) with no logging

### File: `src\core\domain\gemini_api.py`

- **Line 228** - EXH003: Silent exception handler (except: pass) with no logging
