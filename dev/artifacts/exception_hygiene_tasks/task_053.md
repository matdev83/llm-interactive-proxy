# Exception Hygiene Fix Task - Iteration 53/72
...
- **Line 396** - EXH003: Silent exception handler (except: pass) with no logging

### File: `src\connectors\gemini_cloud_project.py`

- **Line 164** - EXH003: Silent exception handler (except: pass) with no logging
- **Line 937** - EXH003: Silent exception handler (except: pass) with no logging
