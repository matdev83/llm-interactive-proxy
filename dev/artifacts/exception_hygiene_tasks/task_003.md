# Exception Hygiene Fix Task - Iteration 3/72
...
- **Line 1256** - EXH001: Missing exc_info=True in logger call within exception handler

### File: `src\connectors\anthropic_oauth.py`

- **Line 336** - EXH001: Missing exc_info=True in logger call within exception handler
- **Line 377** - EXH001: Missing exc_info=True in logger call within exception handler
