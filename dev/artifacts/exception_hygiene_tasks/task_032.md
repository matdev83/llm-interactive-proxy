# Exception Hygiene Fix Task - Iteration 32/72
...
### File: `src\core\services\artifact_service.py`

- **Line 203** - EXH001: Missing exc_info=True in logger call within exception handler
