...
def test_size_limit():
    ...
    boundary_under_payload = '{"function_call": {"name": "test", "arguments": {"data": "' + 'x' * int(boundary_under_mb * 1024 * 1024 * 0.8) + '"}}}'
    ...
    boundary_over_payload = '{"function_call": {"name": "test", "arguments": {"data": "' + 'x' * int(boundary_over_mb * 1024 * 1024 * 0.8) + '"}}}'
