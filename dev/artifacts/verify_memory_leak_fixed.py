...
def verify_memory_leak_fixed():
        ...
        [
            {
                "id": "cleanup_trigger",
                "extra_content": {
                    "google": {"thought_signature": "cleanup_trigger_sig"}
                },
            }
        ],
        "cleanup_session",
    ...
    print(
        f"Anonymous entries: before={anon_before}, cleared={cleared}, after={anon_after}"
    )
    ...
    print(
        f"Session cleanup: before={session_before}, after={session_after}, cleared={cleared}"
    )
