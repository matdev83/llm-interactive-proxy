...
config_schema_pairs = [
    ...
    ('config/identity_factory_droid.example.yaml', 'config/schemas/app_config.schema.yaml'),
    ('config/sso_auth.example.yaml', 'config/schemas/app_config.schema.yaml'),
    
    # Standalone configs
    ('config/tool_call_reactor_config.yaml', 'config/schemas/tool_call_reactor_config.schema.yaml'),
    ...
    ('config/reasoning_aliases.yaml.example', 'config/schemas/reasoning_aliases.schema.yaml'),
    
    # Backend configs
    ('config/backends/openai_codex/backend.yaml', 'config/schemas/openai_codex_backend.schema.yaml'),
    ('config/backends/openai_codex.yaml.example', 'config/schemas/openai_codex_backend.schema.yaml'),
    ('config/tool_access_control_examples.yaml', 'config/schemas/tool_call_reactor_config.schema.yaml'),
]
